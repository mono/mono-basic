...
SET VMW4J2EE_JGAC_DIR=%VMW_HOME%\jgac\vmw4j2ee_110
:JGAC_DEFINED
...
SET VMW4J2EE_JGAC_JARS=%VMW4J2EE_JGAC_JARS%;"%VMW4J2EE_JGAC_DIR%\vmwutils.jar"
SET VMW4J2EE_JGAC_JARS=%VMW4J2EE_JGAC_JARS%;"%VMW4J2EE_JGAC_DIR%\J2SE.Helpers.jar"
