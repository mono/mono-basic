...
set OUTPUT_FILE_PREFIX=VisualBasic_VB
set RUNNING_FIXTURE=MonoTests.Microsoft_VisualBasic
set TEST_SOLUTION=Test\2005VB_test_VB.JavaEE.sln
set TEST_ASSEMBLY=Microsoft.2005_VisualBasic_test_VB.jar
...
set RUNTIME_CLASSPATH=%RUNTIME_CLASSPATH%;%JGAC_PATH%Microsoft.VisualBasic.jar
...
set NUNIT_CLASSPATH=%NUNIT_PATH_BIN%\nunit.framework.jar
set NUNIT_CLASSPATH=%NUNIT_CLASSPATH%;%NUNIT_PATH_BIN%\nunit.util.jar
set NUNIT_CLASSPATH=%NUNIT_CLASSPATH%;%NUNIT_PATH_BIN%\nunit.core.jar
set NUNIT_CLASSPATH=%NUNIT_CLASSPATH%;%NUNIT_PATH_BIN%\nunit-console.jar
