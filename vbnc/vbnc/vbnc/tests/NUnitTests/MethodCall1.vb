''' <summary>
''' Method calls with no parameters and no parenthesis.
''' </summary>
''' <remarks></remarks>
<TestFixture()> Public Class MethodCall1
    ...
    <Test()> Public Sub Test5()
        Dim var As MethodCall1
        var = New MethodCall1(5)
    ...
    Shared Function Method1() As MethodCall1
        Return New MethodCall1
    End Function
    ...
    Function Method6() As MethodCall1
        Return Me
    End Function
End Class