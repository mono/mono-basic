...
#If ENABLECECIL Then
        m_CecilBuilder = New Mono.Cecil.EventDefinition(Name, Helper.GetTypeOrTypeReference(Compiler, m_EventType), Mono.Cecil.EventAttributes.SpecialName)
        parent.CecilType.Events.Add(m_CecilBuilder)
#End If
