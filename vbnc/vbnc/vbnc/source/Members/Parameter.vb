...
#If ENABLECECIL Then
            If m_ParameterBuilderCecil IsNot Nothing Then
                m_ParameterBuilderCecil.IsOptional = True
                m_ParameterBuilderCecil.Constant = m_ConstantValue
...
#If ENABLECECIL Then
    Overloads Function Define(ByVal Builder As Mono.Cecil.MethodDefinition) As Boolean
        m_ParameterBuilderCecil = New Mono.Cecil.ParameterDefinition(Helper.GetTypeOrTypeReference(Compiler, ParameterType))
