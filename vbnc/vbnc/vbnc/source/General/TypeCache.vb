...
'    Public System_Void As Mono.Cecil.TypeDefinition
'    Public System_DBNull As Mono.Cecil.TypeDefinition
'    Public System_Boolean_Array As Mono.Cecil.ArrayType
'    Public System_Exception As Mono.Cecil.TypeDefinition
'    Public MS_VB_CS_Conversions__ChangeType_Object_Type As Mono.Cecil.MethodReference
'    Public System_Type_Array As Mono.Cecil.ArrayType
'    Public System_Char_Array As Mono.Cecil.ArrayType
'    Public MS_VB_CS_NewLateBinding__LateSet_Object_Type_String_Array_Array_Array As Mono.Cecil.MethodReference
'    Public MS_VB_CS_NewLateBinding__LateGet_Object_Type_String_Array_Array_Array As Mono.Cecil.MethodReference
'    Public MS_VB_CS_NewLateBinding__LateGet_Object_Type_String_Array_Array_Array_Array As Mono.Cecil.MethodReference
'    Public MS_VB_CS_NewLateBinding__LateIndexGet_Object_Array_Array As Mono.Cecil.MethodReference
'    Public MS_VB_CS_NewLateBinding__LateIndexSet_Object_Array_Array As Mono.Cecil.MethodReference
'    Public MS_VB_CS_NewLateBinding__LateCall_Object_Type_String_Array_Array_Array_Array_Boolean As Mono.Cecil.MethodReference
'    Public System_String__ctor_Array As Mono.Cecil.MethodReference
'    Public System_Array As Mono.Cecil.TypeDefinition
'    Public System_Array__SetValue As Mono.Cecil.MethodDefinition
'    Public System_Array__GetValue As Mono.Cecil.MethodDefinition
'    Public System_Array__CreateInstance As Mono.Cecil.MethodDefinition
...
'    Public System_Reflection_AssemblyVersionAttribute As Mono.Cecil.TypeDefinition
'    Public System_Reflection_AssemblyProductAttribute As Mono.Cecil.TypeDefinition
'    Public System_Activator__CreateInstance As Mono.Cecil.MethodReference
'    Public System_Reflection_AssemblyCompanyAttribute As Mono.Cecil.TypeDefinition
'    Public System_Reflection_AssemblyCopyrightAttribute As Mono.Cecil.TypeDefinition
'    Public System_Reflection_AssemblyTrademarkAttribute As Mono.Cecil.TypeDefinition
'    Public System_Reflection_AssemblyKeyNameAttribute As Mono.Cecil.TypeDefinition
