Public Module JaggedArrayPropertyVariableUInteger1
    Dim _a As UInteger()
    Dim _b As UInteger()()
    Dim _c As UInteger()()()
    Dim _d As UInteger()()()()
