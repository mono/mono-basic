...
Public Class CUIntExpression
    ...
    Overloads Shared Function GenerateCode(ByVal Expression As Expression, ByVal Info As EmitInfo) As Boolean
        ...
        Select Case expTypeCode
            ...
            Case TypeCode.Single
                ...
                Emitter.EmitCall(Info, Info.Compiler.TypeCache.System_Math_Round__Double)
                Emitter.EmitConv_U4_Overflow(Info, Info.Compiler.TypeCache.Double)
            Case TypeCode.Object
                If Helper.CompareType(expType, Info.Compiler.TypeCache.Object) Then
                    Emitter.EmitCall(Info, Info.Compiler.TypeCache.MS_VB_CS_Conversions_ToUInteger__Object)
                Else
                    Helper.NotImplemented()
                End If
            Case TypeCode.String
                Emitter.EmitCall(Info, Info.Compiler.TypeCache.MS_VB_CS_Conversions_ToUInteger__String)
            Case TypeCode.Decimal
                Emitter.EmitCall(Info, Info.Compiler.TypeCache.System_Convert_ToUInt32__Decimal)
            Case Else
                Helper.NotImplemented()
        End Select
    ...
    Public Overrides ReadOnly Property ConstantValue() As Object
        Get
            ...
            Select Case tpCode
                ...
                Case TypeCode.SByte, TypeCode.Int16, TypeCode.Int32, TypeCode.UInt64, TypeCode.Int64, TypeCode.Single, TypeCode.Double, TypeCode.Decimal
    ...
    Overrides ReadOnly Property ExpressionType() As Type
        Get
            Return Compiler.TypeCache.UInteger '_Descriptor
        End Get
    End Property
End Class
