...
Public Class CLngExpression
    ...
    Shared Function Validate(ByVal Info As ResolveInfo, ByVal SourceType As Type) As Boolean
        ...
        Dim ExpressionType As Type = Info.Compiler.TypeCache.Long
    ...
    Overloads Shared Function GenerateCode(ByVal Expression As Expression, ByVal Info As EmitInfo) As Boolean
        ...
        Select Case expTypeCode
            ...
            Case TypeCode.Single
                ...
                Emitter.EmitCall(Info, Info.Compiler.TypeCache.System_Math_Round__Double)
                Emitter.EmitConv_I8_Overflow(Info, Info.Compiler.TypeCache.Double)
            Case TypeCode.Object
                If Helper.CompareType(expType, Info.Compiler.TypeCache.Object) Then
                    Emitter.EmitCall(Info, Info.Compiler.TypeCache.MS_VB_CS_Conversions_ToLong__Object)
                Else
                    Helper.NotImplemented()
                End If
            Case TypeCode.String
                Emitter.EmitCall(Info, Info.Compiler.TypeCache.MS_VB_CS_Conversions_ToLong__String)
            Case TypeCode.Decimal
                Emitter.EmitCall(Info, Info.Compiler.TypeCache.System_Convert_ToInt64__Decimal)
            Case Else
                Helper.NotImplemented()
        End Select
    ...
    Overrides ReadOnly Property ExpressionType() As Type
        Get
            Return Compiler.TypeCache.Long '_Descriptor
        End Get
    End Property
End Class
