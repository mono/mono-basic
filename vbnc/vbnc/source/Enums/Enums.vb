...
Module Enums
    ...
    Private keywordLookup As New Hashtable(StringComparer.InvariantCultureIgnoreCase)
    ...
    Function GetTypeCharacterCacheStringAttribyte(ByVal Value As TypeCharacters) As TypeCharactersEnumStringAttribute
        Return DirectCast(System.Attribute.GetCustomAttribute(GetType(TypeCharacters).GetField(Value.ToString), GetType(TypeCharactersEnumStringAttribute)), TypeCharactersEnumStringAttribute)
    End Function
